...
This project analyzes sales and performance data for a Bike Store using Excel tools, including Power Query, Power Pivot, and DAX. The goal is to clean, transform, model, and visualize the data to uncover key insights that support better business decisions.
